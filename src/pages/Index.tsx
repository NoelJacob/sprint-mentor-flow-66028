...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      <div className="container mx-auto px-4 sm:px-6 py-24 sm:py-16">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto px-4 leading-relaxed">
            Real-time insights and proactive nudges for Scrum Masters and Tech
            Leads. Choose your persona to explore the dashboard.
          </p>
        </div>

        <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-3xl mx-auto px-4">
          <PersonaCard type="scrum-master" onSelect={handlePersonaSelect} />
          <PersonaCard type="tech-lead" onSelect={handlePersonaSelect} />
        </div>

        <div className="mt-10 sm:mt-16 text-center px-4">
          <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4 uppercase tracking-wider font-medium">
            Key Features
          </p>
